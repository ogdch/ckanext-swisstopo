...
class SwisstopoCkanMetadata(CkanMetadata):
    ...
    mapping = {
        ...
        'url': XPathTextAttribute(
            ...
            "//gmd:linkage//che:URLGroup/che:LocalisedURL[@locale='#DE']"
        ),
        ...
        'author_email': FirstInOrderAttribute([
            XPathTextAttribute(
                ...
                "/ancestor::gmd:pointOfContact//gmd:address"
        ...
        'tags': ArrayAttribute([XPathMultiTextAttribute(
    ...
    def get_id_by_dataset_name(self, dataset_name):
        ...
        return (
            super(SwisstopoCkanMetadata, self)
